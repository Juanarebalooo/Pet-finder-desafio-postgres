...
export function makeReportsPage() {
  const rootEl = document.querySelector(".root");
  if (rootEl) {
    rootEl.innerHTML = `
    <header-el></header-el>
    <title-el text-title="Reportar mascota"></title-el>
    <text-el text="Ingresá la siguiente información para realizar el reporte de la mascota"></text-el>
    ...
    <button class="foto-input">Toca aquí para añadir una imagen de tu mascota</button>
    ...
    <div class="last-cont">
    <button-el class="report-pet-button"text-button="Reportar mascota" color-button="green"></button-el>
    ...
    const cancelButton = rootEl.querySelector(".cancel-button") as HTMLElement;
